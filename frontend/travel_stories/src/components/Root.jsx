...
const Root = () => {
  ...
  return(
    ...
    <section className="py-10 sm:py-16 lg:py-24 bg-cyan-100/20">
                ...
                <div>
                    <h1 className="text-4xl font-bold text-black sm:text-4xl lg:text-5xl">
                        ...
                        <div className="relative inline-flex mt-2">
                            <span className="absolute inset-x-0 bottom-0 border-b-[30px] border border-cyan-200"></span>
                            <h1 className="relative text-4xl font-bold text-black sm:text-4xl lg:text-5xl">Share Adventures</h1>
                        </div>
                    </h1>

                    <p className="mt-8 text-base  text-black sm:text-xl">Turn your travel memories into stories that inspire. Share your journeys, connect with fellow explorers, and let your adventures resonate around the globe. Start sharing and inspire the world today.</p>

                    <div className="mt-10 sm:flex sm:items-center justify-end sm:space-x-8">
                        <div  className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-600"  onClick={()=>onstarted()} >Share Story</div>
